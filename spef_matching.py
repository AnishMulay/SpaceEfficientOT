...
def spef_matching_torch(
    ...
    while f > f_threshold:
        ...
        free_S_edge_B_ind_range_rt_exclusive = torch.cat((free_S_edge_B_ind_range_lt_inclusive[1:], torch.tensor(global_ind_S_zero_ind[0].shape, device=device, dtype=dtyp, requires_grad=False)))
